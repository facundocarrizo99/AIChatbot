...
class MonotributistaController:
    ...
    def crear_monotributista(self, tele_original, nombreCompleto, telefono, email, condicionIva, cuit, domicilio,
                             razonSocial, categoria_monotributo, actividad, punto_venta, ingresos_brutos,
    ...
    def agregar_cliente(self, telefono_monotributista, nombre_completo, telefono, email, condicion_iva, cuit,
                        domicilio):
